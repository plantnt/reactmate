...
<div className="border-2 bg-gray-50 rounded-r-3xl rounded-l-3xl w-[98%] my-[15px]">
            ...
            <div className="max-w-[180px] rounded-xl border border-slate-200">
        ...
        <div className="flex space-x-5 w-[290px]">
                <button className="bg-violet-500 hover:bg-violet-600 transition duration-300 border-2 border-violet-800 text-white font-bold py-2 px-4 rounded-3xl w-[120px]">
