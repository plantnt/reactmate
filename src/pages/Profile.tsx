...
export default function Profile() {
  ...
  return (
    <>
      <div className="bg-gray-50 min-h-screen py-8"> {/* Cambio del color de fondo a bg-gray-50 */}
          ...
          <div className="md:flex">
            ...
            <div className="p-8 text-center">
              <div className="uppercase tracking-wide text-sm text-indigo-600 font-bold">
                <h1 className="text-2xl">donjuan700</h1>
              </div>
              <p className="text-indigo-700 font-semibold">VENDEDOR</p>
              <br />
              <p className="mt-2 text-gray-500 font-semibold">
                ...
                OJO Q EL FORO EXTERNO ES SOLAMENTE TEMPORAL
              </p>
              <br />
              ...
              <div className="mt-4 flex justify-between">
                <a href="https://furnimate.foroactivo.com/">
                  <button className="bg-blue-500 hover:bg-white hover:text-blue-500 hover:border-blue-500 transition duration-300 border-2 border-blue-500 text-white font-bold py-2 px-4 rounded flex items-center">
                    <FaRegCommentDots className="inline-block mr-2 text-xl" />
                    <span className="text-base">Abrir Foro</span>
                  </button>
                </a>
                <a href="http://localhost:3000/">
                  <button className="bg-green-500 hover:bg-white hover:text-green-500 hover:border-green-500 transition duration-300 border-2 border-green-500 text-white font-bold py-2 px-4 rounded flex items-center justify-center">
                    ...
                    <span className="text-base">Ver en Catálogo</span>
                  </button>
                </a>
                ...
                <div ref={dropdownRef} className="">
                  ...
                  >
                    <span className="text-base">Opciones</span>
                  ...
                  {isOpen && (
                    ...
                    >
                      <div className="py-1">
                        <p className="text-sm px-4 py-2 hover:bg-gray-100 cursor-pointer">Modificar perfil</p>
                        <p className="text-sm px-4 py-2 hover:bg-gray-100 cursor-pointer">Modificar contraseña</p>
                        <p className="text-sm px-4 py-2 hover:bg-gray-100 cursor-pointer">Eliminar cuenta</p>
                      </div>
                    </div>
                  )}
                </div>
        ...
        <h1 className="text-center text-gray-400">*Se filtrarán solamente los productos de este usuario*</h1>
        <br></br>
