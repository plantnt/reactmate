    ...
    <h1 className="text-5xl font-bold font-extrawide text-white -mt-3 p-4 flex">
        Foro
            ...
            {isLogged ? (
                ...
                <h1 className="text-center p-44 bg-white-500 text-black">Por favor, inicia sesión para acceder al foro. <NavLink to="/logIn"><span className="text-purple-500">inicia sesion</span></NavLink></h1>
            )}
        </>
    );
};
