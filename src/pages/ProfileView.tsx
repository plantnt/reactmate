      ...
      <div className='flex h-[100vh] w-full'>
        <div className='p-5 border-r-2 min-w-[300px]'>
          <div className='flex flex-col items-center'>
            ...
            <div className="text-center max-w-[200px] mt-5">
              <h3 className='text-wrap text-xl font-semibold'>{userData.name || 'Juanca'} {userData.last_name || 'Fernandez'}</h3>
            </div>
          </div>
          <hr className='mt-7'/>
          <div className="flex flex-col items-center mt-4">
            ...
            <label className='flex mt-3'>
              ...
              <p className='cursor-text truncate w-[190px]' title={userData.email || 'juancafercho@gmail.com'}>
                {userData.email || 'juancafercho@gmail.com'}
              </p>
            </label>
            <div className="flex flex-col items-center justify-center space-y-5 mt-7">
              <label className='flex items-center'>
                  <div className='flex flex-col items-center space-y-2'>
                    <p className='font-semibold w-[190px]' title={userData.phonenum || '4342092112'}>Teléfono: {userData.phonenum || '4342092112'}</p>
            ...
            <div className="flex flex-col items-center justify-center space-y-5 mt-3">
              <label className='flex items-center'>
                <div className='flex flex-col items-center space-y-2'>
                    <p className='font-semibold truncate w-[190px]' title={userData.address || 'Cra 45 #56 D 12'}>Dirección: {userData.address || 'Cra 45 #56 D 12'}</p>
        ...
        <div className="flex flex-col">
          <div className='flex flex-wrap gap-3 p-3 overflow-hidden h-full w-full'>
            <h3 className='text-wrap text-xl font-semibold'>Productos de {userData.name || 'Juanca'} {userData.last_name || 'Fernandez'}</h3>
